...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = "stopwords-filter2"
  gem.homepage = "http://github.com/aaronstillwell/stopwords-filter2"
  gem.license = "MIT"
  ...
  gem.email = "stillwell.mailbox@gmail.com"
  gem.authors = ["Aaron Stillwell", "David J. Brenes"]
